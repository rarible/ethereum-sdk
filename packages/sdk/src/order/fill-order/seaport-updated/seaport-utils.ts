...
export async function fulfillOrder(
	...
	console.log("before balances and approvals")
	const [
	...
	console.log("before validateAndSanitizeFromOrderStatus")
    ...
    shouldUseBasicFulfill(sanitizedOrder.parameters, totalFilled)
		...
		console.log("before approveBeforeBasicFulfillOrder")
		...
		console.log("before fulfillBasicOrder")
	...
	console.log("before approveBeforeStandardFulfillOrder")
	...
	console.log("before fulfillStandardOrder")
