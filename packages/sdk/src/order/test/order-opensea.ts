...
export const OPENSEA_ORDER_DELEGATE_TEMPLATE: Omit<SimpleOpenSeaV1Order, "make" | "take"> = {
	...OPENSEA_ORDER_TEMPLATE,
	data: {
		...OPENSEA_ORDER_TEMPLATE.data,
		howToCall: OrderOpenSeaV1DataV1HowToCall.DELEGATE_CALL,
	},
}
...
export function getOrderTemplate(
	makeAsset: TestAssetClass, takeAsset: TestAssetClass, side: OrderOpenSeaV1DataV1Side, delegate: boolean = false
): SimpleOpenSeaV1Order {
	const template = delegate ? OPENSEA_ORDER_DELEGATE_TEMPLATE : OPENSEA_ORDER_TEMPLATE
